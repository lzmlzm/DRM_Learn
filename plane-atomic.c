...
int main(int argc, char **argv)
{
	...
	drmModeAtomicAddProperty(req, plane_id, property_crtc_x, 500);
	drmModeAtomicAddProperty(req, plane_id, property_crtc_y, 500);
	drmModeAtomicAddProperty(req, plane_id, property_crtc_w, 32);
	drmModeAtomicAddProperty(req, plane_id, property_crtc_h, 32);
	drmModeAtomicAddProperty(req, plane_id, property_src_x, 0 << 16);
	drmModeAtomicAddProperty(req, plane_id, property_src_y, 0 << 16);
	drmModeAtomicAddProperty(req, plane_id, property_src_w, 3200 << 16);
	drmModeAtomicAddProperty(req, plane_id, property_src_h, 3200 << 16);
